...
Revision ID: 314f24854a22
Revises: 
Create Date: 2022-10-04 23:22:18.995653
...
def upgrade():
    ...
    sa.Column('category', sa.Enum('BARBELL', 'DUMBBELL', 'MACHINE', 'CABLE', 'W_BODYWEIGHT', 'A_BODYWEIGHT', 'CARDIO', 'OTHER', name='category'), nullable=False),
    sa.Column('body_part', sa.Enum('ABS', 'ARMS', 'BACK', 'CHEST', 'LEGS', 'SHOULDERS', 'FULL_BODY', 'CARDIO', 'OTHER', name='bodypart'), nullable=False),
    ...
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
    sa.Column('category', sa.Enum('CORE', 'BODY_PART', name='measurementcategory'), nullable=False),
    sa.Column('reading', sa.DECIMAL(precision=5, scale=2), nullable=False),
    sa.Column('unit', sa.Enum('WEIGHT', 'PERCENT', 'LENGHT', name='measurementunit'), nullable=False),
    ...
    sa.Column('id', sqlalchemy_utils.types.uuid.UUIDType(binary=False), nullable=False),
    sa.Column('weight', sa.DECIMAL(precision=5, scale=2), nullable=True),
    sa.Column('set_type', sa.Enum('WARM_UP', 'NORMAL', 'FAILURE', name='settype'), nullable=False),
